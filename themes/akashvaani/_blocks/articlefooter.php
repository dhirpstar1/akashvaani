  <!-- Footer -->
    	...
    	<script src="<?= base_url() ?>/assets/js/datetimepicker/js/bootstrap-datetimepicker.min.js" type="text/javascript"></script>
        <script src="<?php echo base_url(); ?>assets/js/jquery.touchSwipe.min.js"></script>
        <script src="<?php echo base_url(); ?>assets/js/jquery.visible.js"></script>
        <script src="<?php echo base_url(); ?>assets/js/signin.js" type="text/javascript"></script>
        <script> $('body').removeClass('hidden').addClass('no-hidden'); </script>
