...
<!-- End Google Tag Manager (noscript) -->
        ...
        <div id="landingpage">
         <div id="" class="carousel slide" data-ride="">
                ...
                <div class="carousel-inner">
                    <div class="item active" style="background-image: url(<?php echo base_url(); ?>assets/images/slider/slider1.png)">
                        <div class="container">
                         ...
                         <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 landingheaderdiv" style="text-align:left;">
                         <h1>India’s first media planning & buying tool redefining TV advertising</h1>
                          <div class="landingheightdiv">
                          
                          &nbsp;</div>
                          <div class="landingsubheader">
                          
                          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12"> 
                          
                          <a href="" class="btn btn-green"><span class='fa fa-phone'></span>&nbsp;&nbsp;959 956 4835</a>
                          
                          <a href="" class="btn btn-green"><span class='fa fa-envelope-o'></span>&nbsp;&nbsp;connect@akashvaani.com</a>
                         
                          
                                       </div>
                          
                          <h4>Are you a first time advertiser? </h4>
                          <h4>Download our step-by-step guide for TV advertising <a href="#">DOWNLOAD NOW</a> </h4>
                          </div>
                         </div>                           
                          <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 landingrightbox">                           
                                      
                              <div><h2>Book Pandit Now</h2>
                              <h4>*Available in Delhi, Gurgaon, Noida</h4>
                              </div>        
                                                    
                            <?php echo form_open('services/bookingnow', array('class' => 'form-horizontal', 'id' => 'addbooking')); ?>	
						  <?php echo form_input(array('type' => 'hidden', 'name' => 'type', 'value' => 'phone')); ?>
                            ...
                            <div class="row nonregrow">
                             ...
                             <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 cfItem input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-sort"></i></span>
  		 ...
  		 <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 cfItem input-group">
          <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
   <?php echo form_input(array('type' => 'text', 'class' => 'form-control', 'name' => 'first_name', 'required' => 'required', 'placeholder' => 'Name', 'value' => '')); ?>	
                                 </div>
  ...
  <?php echo form_input(array('type' => 'email', 'class' => 'form-control', 'name' => 'email', 'required' => 'required', 'placeholder' => 'Email', 'value' => '')); ?>	
   ...
   <?php echo form_input(array('type' => 'phone',  'class' => 'form-control','name' => 'phone', 'required' => 'required', 'placeholder' => 'Phone', 'value' => '')); ?>	
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 cfItem input-group">
   <?php echo form_textarea(array('type' => 'phone',  'class' => 'form-control','name' => 'description', 'rows' => 3)); ?>	
                            </div>
                    ...
                    <div class="loader col-xs-12 col-sm-12 col-md-12 col-lg-12" align="center"></div>
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12"> 
   ...
   $('form#addbooking').submit(function(e) {
    ...
    $.ajax({
        type: "POST",
        url: "<?php echo site_url('services/bookingnow'); ?>",
        data: form.serialize(),
		...
		$('#addbooking')[0].reset();
		$('.loader').html(''); 
		if(data == 'success'){ window.location.replace('<?php echo base_url().'pages/thankyou.htm'; ?>');}
...
<div class="home-header col-md-12">
    ...
    <nav class="navbar navbar-default new_menu navbar-fixed-top">
     <div class="home-logo osLight col-md-6"><a href="<?php echo base_url(); ?>" ><img src="<?php echo image_resize('assets/images/logo.png', 100, 100); ?>" alt="Logo" width="100">  </a></div>
