...
<!-- End Google Tag Manager (noscript) -->
  ...
  <?php echo form_input(array('type' => 'email', 'class' => 'form-control', 'name' => 'email', 'required' => 'required', 'placeholder' => 'Email', 'value' => '')); ?>	
   ...
   <?php echo form_input(array('type' => 'phone',  'class' => 'form-control','name' => 'phone', 'required' => 'required', 'placeholder' => 'Phone', 'value' => '')); ?>	
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 cfItem input-group">
   <?php echo form_textarea(array('type' => 'phone',  'class' => 'form-control','name' => 'description', 'rows' => 5)); ?>	
                            </div>
                ...
                <?php echo form_close(); ?>   
                    ...
                    <div class="item " style="background-image: url(<?php echo base_url(); ?>assets/images/slider/slider1.png)">
                        <div class="container">
                            <div class="carousel-caption">
  ...
  <div class="container-fluid col-md-8">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <li><a href="<?php echo base_url('/product'); ?>" >Products</a></li>
       ...
       <li style="width:100px;"><a href="#"></a></li>
