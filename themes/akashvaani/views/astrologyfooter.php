...
<div id="bottom">
      <div class="col-md-12" style="text-align:right">
        <div class="col-md-9 col-xs-12">
           <p class="cc_message" style="text-align: left;padding-left: 20px; color: #ffffff;"> <span id="quecount">...</span><span style="font-size: 10px; "> question(s) selected.</span> <br>  
         <span id="amountcalc"> ...</span>....  </p>
        </div>
<div class="cc_banner cc_container cc_container--open col-md-2 col-xs-6">
          <a href="javascript:void(0);" class="cc_btn cc_btn_accept_all" style="max-width: 75px;">Proceed</a>
  ...
  function call_from_child(count){
    var amounttext = '';
     for (i = 0; i < count; i++) {
         if(i < 3){
              if(i == 0){
                    amounttext += 'INR <?=get_key_data('PER_QUESTION_PRICE', $cccode, false);?>/- ';
              }else{
                 amounttext += ' + INR <?=get_key_data('OTHER_QUESTION_PRICE', $cccode, false);?>/- ';
              }
        }
    } 
