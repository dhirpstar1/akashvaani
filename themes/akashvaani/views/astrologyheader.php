...
<div id="carousel-example-2" class="carousel slide carousel-fade" data-ride="carousel">
  ...
  <div class="carousel-inner" role="listbox">
    ...
    <div class="carousel-item active">
      <!--Mask color-->
      <div class="view">
        <img src="<?php echo base_url('/assets/astrology/'); ?>/img/astrology.jpg" class="img-fluid" alt="">
      ...
      <div class="carousel-caption sider-caption">
        <div class="animated fadeInDown">
          <div class="col-md-12">
            <h3 class="white-text"><span class="name ch">Book Astrologer</span><br></h3>
      ...
      <div class="carousel-item">
        <!--Mask color-->
        <div class="view">
          <img src="<?php echo base_url('/assets/astrology/'); ?>/img/marriage.jpg" class="img-fluid" alt="">
          <div class="full-bg-img">
          </div>
        </div>
        <!--Caption-->
        <div class="carousel-caption sider-caption">
         <div class="animated fadeInDown">
          <div class="col-md-12">
            <h3 class="white-text"><span class="name ch">For Marriage Astrology</span><br></h3>
             <h5 style="color:#484848"><span class="cp">Marriage Prediction - Kundali Milan</span></h5>
              <div class="col-md-12">
                <a class="btn btn-outline-white btn-rounded waves-effect waves-light explore" href="https://www.akashvaani.com/astrology/online-marriage-prediction">Explore</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="carousel-item">
        <!--Mask color-->
        <div class="view">
          <img src="<?php echo base_url('/assets/astrology/'); ?>/img/career.jpg" class="img-fluid" alt="">
          <div class="full-bg-img">
          </div>
        </div>
        <!--Caption-->
        <div class="carousel-caption sider-caption">
         <div class="animated fadeInDown">
          <div class="col-md-12">
            <h3 class="white-text"><span class="name ch">Career Astrology</span><br></h3>
             <h5 style="color:#484848"><span class="cp">Career Obstacles, Job prediction</span></h5>
              <div class="col-md-12">
                <a class="btn btn-outline-white btn-rounded waves-effect waves-light explore" href="https://www.akashvaani.com/online-career-and-job">Explore</a>
              </div>
            </div>
          </div>
        </div>
