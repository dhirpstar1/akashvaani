...
<body>
 ...
 <li><a class="collapsible-header waves-effect arrow-r" data-toggle="collapse" href="#horoscope" aria-expanded="false" aria-controls="collapseExample"><span class="healthicon"></span> Horoscope<i class="fa fa-angle-down rotate-icon"></i></a>
          ...
          <div class="collapse" id="collapseExample2">
            <div class="collapseitem">
              <ul>
                <li><a class="collapsible-header waves-effect arrow-r" data-toggle="collapse" href="#" aria-expanded="false" aria-controls="collapseExample"><span class="marriageicon"></span> Gemstones<i class="fa fa-angle-down rotate-icon"></i></a>
    ...
    <div class="dropdown-content card">
        ...
        <div class="col-md-3">
         <ul class="navlink">
          ...
          <li><a class="dropdown-item waves-effect waves-light" href="<?php echo base_url('/astrology/online-career-and-jobr'); ?>">Job & career</a></li>
          <li><a class="dropdown-item waves-effect waves-light">Prediction & Analysis</a></li>
        </ul>
      </div>
      <div class="col-md-3">
...
<div id="carousel-example-2" class="carousel slide carousel-fade" data-ride="carousel">
  ...
  <div class="carousel-inner" role="listbox">
    ...
    <div class="carousel-item active">
      <!--Mask color-->
      <div class="view">
        <img src="<?php echo base_url('/assets/astrology/'); ?>/img/pujabanner1.jpg" class="img-fluid" alt="">
      ...
      <div class="carousel-caption sider-caption">
        <div class="animated fadeInDown">
          <div class="col-md-12">
            <h3 class="white-text"><span class="name ch">Book Pandit In<br/>Delhi & NCR</span><br></h3>
            <h5 style="color:#484848"><span class="cp">For all Kinds of Puja</span></h5>
              <div class="col-md-12">
                <a class="btn btn-outline-white btn-rounded waves-effect waves-light explore" href="https://www.akashvaani.com/puja/book_pandit">Book Now</a>
              </div>
            </div>
          </div>
        </div>
