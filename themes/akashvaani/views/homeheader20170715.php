  ...
  <div class="carousel-inner" role="listbox">
    ...
    <div class="carousel-item">
      ...
      <div class="view">
       ...
       <?php if($device == 'mobile'){ ?>
	   <img src="<?php echo resizedUrl(base_url('/assets/astrology/img/banner 2.jpg'), 600, 250); ?>" class="img-fluid" alt="">
	  <?php }else{ ?>
      <img src="<?php echo base_url('/assets/astrology/img/banner 2.jpg'); ?>" class="img-fluid" alt="">
      <?php } ?>
       <div class="full-bg-img"> </div>
      </div>
      <!--Caption-->
