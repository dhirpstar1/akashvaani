<div class="view bookpandit" style="background-image:url('<?php echo base_url('/assets/astrology/img/'.$customheader); ?>')">
      ...
      <div class="row text-center">
        ...
        <div class="col-md-4 mb-r">
          <div class="testimonial">
            <!--Content-->
            <h4>Geetika</h4>
            <p><i class="fa fa-quote-left"></i>I was anxious about when I was getting married, Akashvaani's astrologer helped me clear a lot of my worry. She knew the answers to my questions and explained the vedic way to me.</p>
            <!--Review-->
