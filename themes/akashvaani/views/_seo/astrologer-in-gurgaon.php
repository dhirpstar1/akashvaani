<div class="view astrologer" style="background-image:url('<?php echo base_url('/assets/img/Astrology Header.jpg'); ?>')">
                ...
                <div class="row" id="home">
                    ...
                    <div class="col-md-6">
                        <div class="description" style="margin-bottom:25px">
                            <h3 class="white-text"><span class="name ch">Experienced Astrologer In Gurgaon</span><br></h3>
                            <h5 style="color:#484848"><span class="cp">Best Platform for astrology consultation</span></h5><br>
		...
		<?php echo form_input(array('type' => 'hidden', 'name' => 'category_id', 'value' => 1)); ?>
         <?php echo form_input(array('type' => 'hidden', 'name' => 'reference_page', 'value' => 'astrologer-in-gurgaon')); ?> 
                               <div class="md-form">
...
<section class="section extra-margins">
    ...
    <div class="row">
        ...
        <div class="col-md-4 mb-r">
            ...
            <div class="view overlay hm-white-slight">
                  <img src="<?php echo base_url('/assets/img/rings.jpg'); ?>">
                <a>
                    <div class="mask"></div>
                </a>
            </div>
  ...
  <li style="list-style-type:disc">Know if you are manglik and its effects</li>
    ...
    <div class="row">
        ...
        <div class="col-md-6 mb-r">
            <!--Excerpt-->
             <h4>Our astrologers help you to know about your career and future.</h4>
...
<p>Our astrologers study your birth date and gives description of your planets and their reflection on your career.</p>
    ...
    <div class="row">
        ...
        <div class="col-md-4 mb-r">
            <!--Featured image-->
            <div class="view overlay hm-white-slight">
                 <img src="<?php echo base_url('/assets/img/health 1.jpg'); ?>" alt="Health Astrologer in Gurgaon">
                <a>
                    <div class="mask"></div>
                </a>
            </div>
