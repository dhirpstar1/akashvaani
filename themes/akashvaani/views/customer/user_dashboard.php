                              ...
                              <div>
                                ...
                                <table class="table asked_qsn">
                                    ...
                                    <?php $question_number =0; foreach($questions as $key => $question): $question_number++; ?>
                                        <tr class="qsn_row" data-toggle="collapse" href="#collapse<?=$key?>" id="questionrow<?=$question->id;?>">
                                          ...
                                          <tr id="collapse<?=$key?>" class="collapse questionrow<?=$question->id;?>">
                                          <td><p><strong>Text Answer.</strong></p>
                                           ...
                                           <div class="pull-right"><a href="<?=base_url('/questions_payment/'.$question->booking_id);?>" target="_blank" class="btn btn-success">Proceed to Payment</a></div><br />
                                           <div class="col-md-12" style="padding:10px;"><p class="pull-right" style="color:#000000;">
            For people Outside India &nbsp;&nbsp;&nbsp;<span class="blue-text"><a href="<?=base_url('/service/pay_now/'.$question->booking_id);?>" type="button" id="paynowpaypal">Proceed to payment<span><i class="fa fa-angle-right" aria-hidden="true"></i></span></a></span>
            </p>
            </div>
                                          ...
                                          <a href="<?=base_url('/questions_delete/'.$question->id);?>" class="badge red btn-danger delete_question" title="Delete"><span class="glyphicon glyphicon-remove"></span></a>
