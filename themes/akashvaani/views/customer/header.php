...
<title><?php echo (!empty($seo_title)) ? $seo_title .' - ' : 'Profile :: '; echo config_item('company_name'); ?></title>
<?php if(isset($meta)):?>
...
<link href="<?php echo base_url('/assets'); ?>/landing/css/marriageprediction.css" rel="stylesheet">
...
<body>
    ...
    <div id="mySidenav" class="sidenav">
        <ul id="slide-out" class="side-nav fixed custom-scrollbar ps-container ps-theme-default ps-active-y">
            ...
            <li>
              <div class="user-box">
                        <img src="<?php echo base_url('/assets/profies/thumbnail/'.(($customer['image']) ? $customer['image']:'avatar.png')); ?>" class="img-fluid rounded-circle">
                        <p class="user text-center"><?=$customer['firstname'].' '.$customer['lastname']; ?></p>
                    </div>
        </li>
        <!--/. Logo -->
    ...
    <li>
      ...
      <div class="collapse" id="myaccount">
        <div class="collapseitem">
          <ul>
            <li><a href="<?php echo base_url('/my-account/profile'); ?>" class="waves-effect">profile</a>
            </li>
            <li><a href="<?php echo base_url('/logout'); ?>" class="waves-effect">Log Out</a>
            </li>
    ...
    <li><a class="collapsible-header waves-effect arrow-r" data-toggle="collapse" href="#career" aria-expanded="false" aria-controls="collapseExample"><span class="careericon"></span> Carrer<i class="fa fa-angle-down rotate-icon"></i></a>
      <div class="collapse" id="career">
        <div class="collapseitem">
          <ul>
            <li><a href="<?php echo base_url('/astrology/online-career-and-jobr'); ?>" class="waves-effect">Job & Career</a>
            </li>
...
<li><a class="collapsible-header waves-effect arrow-r" href="<?php echo base_url('/consult-online'); ?>"><span class="articleicon"></span> Ask Question</a></li>
...
<nav class="navbar navbar-fixed-top scrolling-navbar collapsenav">
  ...
  <div class="breadcrumb-dn logo1">
      <a href="<?php echo base_url('/'); ?>"><img src="<?php echo base_url('/assets/'); ?>/img/logo1.png" class="img-fluid flex-center"></a>
  </div>
  ...
  <li class="nav-item dropdown">
    ...
    <div class="col-md-3">
      ...
      <div class="col-md-3">
       <ul class="navlink">
          <li style="font-weight: 500;color:#ec3333;">Horoscope<i class="fa fa-caret-right" aria-hidden="true"></i></li><hr>
 ...
 <li class="nav-item dropdown">
    <a id="contact" class="nav-link waves-effect waves-light contact" href="<?php echo base_url('/p/gemstones'); ?>"> <span class="hidden-sm-down">Products</span></a>
      ...
      <div class="row">
        <div class="col-md-4">
         ...
         <li class="listimg"></li>
          ...
          <li><a class="dropdown-item waves-effect waves-light" href="<?php echo base_url('/p/gemstones/italian-coral-gems'); ?>">Emerald</a></li>
          <li><a class="dropdown-item waves-effect waves-light" href="<?php echo base_url('/p/gemstones/emerald-gems'); ?>">Italian Coral</a></li>
       ...
       <?php if(CI::Login()->isLoggedIn(false, false)):?>
        <div class="u-info">
          <div><img class="profile-img" src="<?php echo base_url('/assets/profies/thumbnail/'.(($customer['image']) ? $customer['image']:'avatar.png')); ?>" alt="" width="70" height="70">
            <div class="u-name"> <a href="<?php echo base_url('my-account/dashboard'); ?>" class="user_name">
              <?=$customer['firstname']; ?>
              </a>
              <div class="number"> +91
                <?=$customer['phone'];?>
