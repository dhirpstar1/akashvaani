...
<div class="view overlay hm-white-slight">
                            <img src="<?php echo base_url('/assets/astrology/img/love-&-marriage-2018-360PX240PX.png'); ?>" alt="First sample image">
                            <a>
                    ...
                    <span class="pdf">(PDF)</span>  
                        ...
                        <a id="button1" href="<?=base_url('/questions?report=8&ctype=8');?>"  class="btn waves-effect waves-light buy_now pull-left">Buy Now</a>
                    </div>
                </div>
            </div>
            <!--/.Author box-->
