...
<div id="carousel-example-2" class="carousel slide carousel-fade" data-ride="carousel">
    ...
    <div style="text-align: center;">
        <a id="button3" class="btn waves-effect waves-light">View Sample Report</a>
    </div>
...
<!--/.Carousel Wrapper-->
  ...
  <div class="col-md-7" style="padding-top: 60px;">
                    ...
                    <a id="button1"  class="btn waves-effect waves-light type_consult">Buy Now</a>
                    <a id="button2" class="btn waves-effect waves-light">Know More</a>
        ...
        <div class="card">
          <div class="card-block">
            ...
            <div class="md-form"> <i class="fa fa-user prefix"></i>
              <input type="text" id="name" class="form-control required" name="first_name" value="<?=$current_customer->firstname.' '.$current_customer->lastname;?>" required="">
  ...
  <!--Panel 3-->
   <div class="tab-pane fade" id="pane23" role="tabpanel">
    ...
    <div class="modal-footer">
      ...
      <button id="skip" type="button" class="btn skp">Skip</button>
  ...
  window.scrollTo(0, 0);
   $('#pane21').removeClass('active in');
	...
	$('#next2').on('click', function(e){
  	window.scrollTo(0, 0);
  $('#pane22').removeClass('in show active');
  $('#pane23').addClass('in show active');
