...
<?php echo form_input(array('type' => 'hidden', 'name' => 'consultation_type', 'value' => $type, 'id' => 'consultation_type')); ?> 
<?php echo form_input(array('type' => 'hidden', 'name' => 'reference_page', 'value' =>  $type)); ?>
<?php echo form_input(array('type' => 'hidden', 'name' => 'language', 'value' => $language)); ?>
<?php echo form_input(array('type' => 'hidden', 'name' => 'reporttype', 'value' => $type)); ?>
<!-- Tab panels -->
 ...
 <div style="clear:both;"></div>
  ...
  <div class="tab-pane fade" id="pane23" role="tabpanel">
    ...
    <ul class="nav nav-tabs md-pills pills-default tab_form" role="tablist">
      <li class="nav-item"> <a class="nav-link active loadformdata" id="individual" data-toggle="tab" href="#panel31" role="tab"><i class="fa fa-user fa-2x"></i><br>
        Individual</a> </li>
      <li class="nav-item"> <a class="nav-link loadformdata" id="couple" data-toggle="tab" href="#panel32" role="tab"><i class="fa fa-heart fa-2x"></i><br>
        Couple</a> </li>
    </ul>
    <!-- Tab panels -->
    <div class="tab-content">
  ...
  window.scrollTo(0, 0);
   $('#pane21').removeClass('active in');
	...
	$('#next2').on('click', function(e){
  	window.scrollTo(0, 0);
	<?php if($type == 'matchmaking_report'){ ?>
