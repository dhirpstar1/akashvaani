...
<div class="container mobile_container">
  ...
  <ol class="breadcrumb" style="background-color:#fff">
	...
	<div class="" id="loadproducts" align="center">
      <div align="center" class="results-showMoreContainer"><span class="fa fa-spin fa-circle-o-notch"></span></div>
  </div>
...
function load_products(url, type){
