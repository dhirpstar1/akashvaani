...
<!-- main -->
<?php echo form_open('service/booking', array('class' => 'form-horizontal', 'id' => 'askquestion')); ?> <?php echo form_input(array('type' => 'hidden', 'name' => 'type', 'value' => 'phone')); ?> <?php echo form_input(array('type' => 'hidden', 'name' => 'category_id', 'value' => 1)); ?> <?php echo form_input(array('type' => 'hidden', 'name' => 'consultation_type', 'value' => 'get_report', 'id' => 'consultation_type')); ?> <?php echo form_input(array('type' => 'hidden', 'name' => 'reference_page', 'value' => 'online-marriage-prediction-get-report')); ?>
<!-- Tab panels -->
