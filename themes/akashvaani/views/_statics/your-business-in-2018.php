...
<div class="view overlay hm-white-slight">
                            <img src="<?php echo base_url('/assets/astrology/img/business.png'); ?>" alt="business">
                            <a>
                    ...
                    <span class="pdf">(PDF)</span>  
                        ...
                        <a id="button1" href="<?=base_url('/questions?report=12&ctype=12');?>"  class="btn waves-effect waves-light buy_now pull-left">Buy Now</a>
                    </div>
                </div>
            </div>
            <!--/.Author box-->
