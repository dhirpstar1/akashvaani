        ...
        <div class="panel-body">
          ...
          <div class="grid-col-12">
            ...
            <div class="clear"  style="clear:both;"></div>
              ...
              <p> <span>Introductory Price</span> <span class="cancel-price"><strike> Rs.399/-</strike></span> <span class="currnt-price" style="color:#0000FF;">Rs.299/-</span> </p>
...
<div class="col-md-12"> <br>
            ...
            <?php /* ?>    <div class="clear"  style="clear:both;"></div>
<br>
...
$(document).ready(function() {
    ...
    <!--////////////////////////////////////-->
    <div class="panel panel-default">
      <div class="card-header white-text"> <a data-toggle="collapse" data-parent="#accordion" href="#collapse1"> kundali chart</a> <a data-toggle="collapse" class="float-xs-right" data-parent="#accordion" href="#collapse1"> <i class="fa fa-chevron-circle-down resultdown" aria-hidden="true"></i></a> </div>
  ...
  drawNorthChart(getPlanetArray(<?php echo json_encode($navamanshachart);?>), getSignArray(<?php echo json_encode($navamanshachart);?>), options,'#navamanshachart');
      ...
      <div class="card-header white-text"> <a data-toggle="collapse" data-parent="#accordion" href="#collapse6"> Planet Details</a> <a data-toggle="collapse" class="float-xs-right" data-parent="#accordion" href="#collapse6"> <i class="fa fa-chevron-circle-down resultdown" aria-hidden="true"></i></a> </div>
