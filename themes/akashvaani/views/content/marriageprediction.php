        ...
        <div class="panel-body">
          ...
          <div class="grid-col-12">
            <div class="col-md-12">
              ...
              <div class="col-md-12">
                <p id="collapseResulthousetype"><?php //echo $general_house_report_jupiter->house_report; ?></p>
              </div>
            </div>
...
<?php /* ?>
              <div class="col-md-12" style="padding: 10px 0 0 0;"><h4 style="color:#ff3366;"><strong>Special offer</strong></h4><br></div>
                <div class="col-md-12" style="padding: 0">
...
<div class="col-md-12" style="padding:10px 0;">  
                   <div class="col-md-4 col-sm-12" style="padding:0px;"><a id="button1" href="<?=base_url('/questions?type=3');?>" class="btn waves-effect waves-light buy_now pull-left">Ask Now</a></div>    
    ...
    <div class="col-md-12" style="padding: 0">
                    ...
                    <div class="col-md-12" style="padding:10px 0;">  
                   <div class="col-md-4 col-sm-12" style="padding:0px;"><a id="button1" href="<?=base_url('/questions?type=5');?>" class="btn waves-effect waves-light buy_now pull-left">Ask Now</a></div>    
