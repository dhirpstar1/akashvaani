      ...
      <div class="row" id="home">
        ...
        <div class="col-md-6">
          <div class="description" style="margin-bottom:25px">
           ...
           <?php /*?> <button type="submit" class="btn-send waves-effect waves-light booknow1">Call Now @<?=CONTACT_NUMBER;?></button><?php */?>
...
<div class="container">
  <hr class="firstheadhr">
  <h2 class="h2-responsive firsthead">Our Top Pandits</h2>
  ...
  <section class="section">
    <div class="row">
      ...
      <div class="col-lg-3 col-md-6 mb-r">
        ...
        <div class="card">
          <!--Card image-->
          <div class="view overlay hm-white-slight"> <img src="<?php echo base_url('/assets/astrology/'); ?>/img/bookpuja.jpg" class="img-fluid" alt="Diwali Pujan" style="position:relative">
            <div class="col-md-12 col-xs-12 servicetitle1">
              <h4 class="card-title serviceh1">Diwali Pujan </h4>
              <a class="btn-floating btn-large red waves-effect waves-light float-xs-right"><i class="fa fa-chevron-right" aria-hidden="true"></i></a></div>
            <a href="<?php echo base_url('puja/diwali-pujan'); ?>">
            <div class="mask waves-effect waves-light"></div>
            </a> </div>
          <!--/.Card image-->
        </div>
