...
<div id="carousel-example-2" class="carousel slide carousel-fade" data-ride="carousel">
  ...
  <div class="carousel-inner" role="listbox">
    ...
    <div class="carousel-item active">
      ...
      <img src="<?php echo base_url('/assets/astrology/img/ask-one-question-slider-mobile.png'); ?>" class="img-fluid" alt="Kundali Matching">
	  <?php }else{ ?>
      <img src="<?php echo base_url('/assets/astrology/img/ask-one-question-slider1.png'); ?>" class="img-fluid" alt="Kundali Matching">
      <?php } ?>
...
<img src="<?php echo base_url('/assets/astrology/img/kundali-milan.jpg'); ?>" alt="Match-Make with your loved One" class="img-fluid">
...
<div class="col-lg-12 col-md-12 col-xs-12 mb-r ">
   ...
   <?php if($device == 'mobile'){ ?>
    ...
    <?php }else{ ?>
          <img src="<?php echo base_url('/assets/astrology/img/kundali-matching-screen.jpg'); ?>" class="img-fluid" alt="" width="100%">
      <?php } ?>
...
<p class="myfont">There are sites which provide the service of online kundali matching. Although, it does not guarantee a high level of accuracy. You should use authentic services for  kundli prediction.
   ...
   <div class="row features-small">
      ...
      <div class="col-md-4 center-on-small-only">  <img src="<?=base_url('/assets/astrology/img/Gun milan.png');?>" alt="Gun milan" class="z-depth-0"></div>
      <!--/First column-->
      <!--Second column-->
