...
<?php echo form_input(array('type' => 'hidden', 'name' => 'selected_heading', 'id' => 'selected_heading', 'value' => $selected_heading)); ?>

<input type="hidden" name="questions" id="questions" value='<?=$questions_selected;?>' />
<!-- Tab panels -->
...
<li class="list-group-item justify-content-between q0"> <span id="q0" class="float-xs-left col-md-10"> <question title="<?=$question_category->name;?>" id="ques_<?=$question_category->id;?>">
       ...
       <?php else: ?>
          ...
          <li class="list-group-item justify-content-between q<?php echo ($key+1); ?>"> <span id="q<?php echo ($key+1); ?>" class="float-xs-left col-md-10">Q<?php echo ($key+1); ?>.
            ...
            </span> <span class="tag red float-xs-right q<?php echo ($key+1); ?>"><a class="q<?php echo ($key+1); ?>" onClick="addQsnOld(this)" style="color:#fff;background-color:#ff3366">ADD(+) </a></span>                </li>
...
function addOwnfrom(opr =''){ 
   ...
   if(selected_heading){
       var selected_heading_data ='<br>' + selected_heading;
   }else{
...
<!-- /.Live preview-->
  ...
  <div class="tab-pane fade" id="pane23" role="tabpanel">
    ...
    <script>
      ...
      <?php if($selected_heading): ?>

      $('#pane21').toggleClass('in active');
      $('#pane22').toggleClass('in active');

      <?php endif; ?>
 function addQsnOld(cls) {
  // body...
...
<div id="bottom" style="display: none;">
      ...
      <div class="cc_banner cc_container cc_container--open">
          ...
          <p class="cc_message" style="text-align: left;padding-left: 20px;"> 
            <span id="quecount"><b>1</b></span><span style="font-size: 10px; "> question(s) selected.</span> <br>  
