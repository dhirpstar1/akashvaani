    ...
    <div class="row cntn">
        <div class="col-md-9">
            ...
            <section class="section extra-margins manglikform">
                ...
                <!--Section heading-->
                <h1 class="section-heading">Vastu Shastra</h1>
                ...
                <div class="row">
                  ...
                  <ol class="breadcrumb" style="background-color:#fff">
                      ...
                      <li class="breadcrumb-item active">Vastu Shastra</li>
                  </ol>    			
                  <section class="section feature-box">

                    <!--Section heading-->
                    <h2 class="h2-responsive firsthead">Vastu Shastra</h2>
                    <!--Section sescription-->
                    <p class="section-description lead" style="margin-left:1%;margin-right:1%;font-size:16px;word-spacing:1px">Vastu Shastra is a traditional concept in Hindu system of architecture, which literally translates to &quot;science of architecture.&quot; It is an ancient Indian science developed thousands of years ago by Indian sages. They laid down rules for the construction of buildings and temples and same has been practiced for centuries,to create old architectural wonders like temples, palaces, monuments etc.</p>
                </section>
                ...
                <div class="col-md-5 mb-r">
                    ...
                    <div class="view overlay hm-white-slight">
                        <img src="<?php echo base_url('/assets/astrology/'); ?>/img/vastu1.png" width="350">
                        <a>
                            <div class="mask"></div>
                        </a>
                    </div>
 ...
 <p class="section-description lead" style="margin-left:1%;margin-right:1%;font-size:16px;word-spacing:1px">Therefore, in short Vaastu shastra is the science of arranging the above-mentioned elements in their respective places so that they are in harmony which in turn will make the lives of people happy and peaceful.</p>
   ...
   <div class="col-md-3 rightsidebar desktopsidebar">
    ...
    <div class="card wow fadeInUp shadowless" style="visibility: visible; animation-name: fadeInUp;">
     ...
     <?php echo form_input(array('type' => 'hidden', 'name' => 'reference_page', 'value' => 'Vastu Shastra Form 1')); ?> 
...
<section class="section feature-box" style="margin-top:3rem">
  ...
  <h1 class="section-heading howorks">What are the Benefits of Vastu Shastra ?</h1>
   ...
   <div class="row features-small">
    ...
    <div class="col-md-4 center-on-small-only"> <img src="<?php echo base_url('/assets/astrology/'); ?>/img/vastu2.png" alt="Vastu Shastra" class="z-depth-0"/> </div>
    <!--/First column-->
  <div class="col-md-6">
        <p class="myfont">
...
<section class="section feature-box" style="margin-top:3rem">
  ...
  <div class="row features-small">
    ...
    <div class="col-md-4 center-on-small-only"> <img src="<?php echo base_url('/assets/astrology/'); ?>/img/vastu3.png" alt="Vastu Tips" class="z-depth-0"> </div>
    <!--/First column-->
    <!--Second column-->
  <div class="col-md-7">
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-content" style="padding:35px;">
                ...
                <div class="modal-body">
                 ...
                 <?php echo form_input(array('type' => 'hidden', 'name' => 'type', 'value' => 'phone')); ?> 
                 <?php echo form_input(array('type' => 'hidden', 'name' => 'category_id', 'value' => 1)); ?>
                 <?php echo form_input(array('type' => 'hidden', 'name' => 'reference_page', 'value' => 'Vastu Shastra Form 2')); ?> 
                 <div class="md-form">
                    <i class="fa fa-user prefix"></i>
      ...
      <div class="col-md-12">
        <div class="card">
          <blockquote class="blockquote bq-primary q1">
            <p class="bq-title">Q.1 What is Vaastu Shastra or Vasthu Shastra or Vastu Veda? </p>
            <p>Ans. Vastu is a Sanskrit word which means dwelling. It describes principles of architectural design, layout, measurements and placement. Vastu is an ancient Indian science of architecture <a href="#" class="read_more">...continue read</a><span class="more_text"> Vastu is a Sanskrit word which means dwelling. It describes principles of architectural design, layout, measurements and placement. Vastu is an ancient Indian science of architecture <a href="#" class="read_less">...read less</a></span></p>
            <div class="item"> </div>
          </blockquote>
        </div>
        <div class="card">
          <blockquote class="blockquote bq-warning q2">
            <p class="bq-title">Q.2 Is Vaastu Shastra associated with any religion? </p>
            <p>Ans.No, Vastu Shastra is not associated with any religion, its is followed by every religion. Vastu Shastra unifies the science, <a href="#" class="read_more1">...continue read</a><span class="more_text1"> art, astronomy and astrology. It helps us to make our lives better and will secure from things going wrong.<a href="#" class="read_less1">...read less</a></span></p>
          </blockquote>
        </div>
        <div class="card">
          <blockquote class="blockquote bq-success q3">
            <p class="bq-title">Q.3 What are the basic principles of Vaastu Shastra?</p>
            <p>Ans. Vaastu is based on the principles  of directions that combines all the five elements of nature and balance them with the man and the material. <a href="#" class="read_more2">...continue read</a><span class="more_text2"> Vaastu Shastra is creating a congenial settings or a place to live or work, in most scientific way taking advantages of the benefits of energies of Earth, Water,  Fire, Air and Space <a href="#" class="read_less2">...read less</a></span></p>
          </blockquote>
        </div>
        <div class="card">
          <blockquote class="blockquote bq-danger q4">
            <p class="bq-title">Q.4 Benefits of Vaastu? </p>
            <p>Ans. . Vastu brings good health, wealth, fortune in your life. Vastu is a medium to attract atable peace of mind and wellbeing. <a href="#" class="read_more3">...continue read</a><span class="more_text3"> It strengthen your connection with others and provide comfort.<a href="#" class="read_less3">...read less</a></span></p>
          </blockquote>
        </div>
        <div class="card">
          <blockquote class="blockquote bq-primary q5">
            <p class="bq-title">Q.5 Is nature an important part of Vastu? </p>
            <p>Ans. Vastu is controlled by Earth, water, sun, fire, air and space. These five natural elements creates vastu energy in our place. <a href="#" class="read_more4">...continue read</a><span class="more_text4">Earth decides plot selection, water decides water flow direction, fire control ventilation, air is for door and windows selection, and space is for room allocation. <a href="#" class="read_less4">...read less</a></span></p>
            <div class="item"> </div>
          </blockquote>
        </div>
        <div class="card">
          <blockquote class="blockquote bq-warning q6">
            <p class="bq-title">Q.6 Few Important things to remember while designing own house, according to vastu? </p>
            <p>Ans. Vastu is necessary for right direction and placement of windows and rooms. You should opt for suitable colors for painting. <a href="#" class="read_more5">...continue read</a><span class="more_text5"> IPainting selection is must to attract positive energies.For children, students room presentation should be must for their career and growth. <a href="#" class="read_less5">...read less</a></span></p>
          </blockquote>
        </div>
      </div>
    </div>
            ...
            <div class="row text-center">
                ...
                <div class="col-lg-3 col-md-12 mb-r">
                    ...
                    <div class="view overlay hm-white-slight z-depth-2">
                        ...
                        <img src="https://www.akashvaani.com/uploads/images/full/59d24a8a82d67c92037beeb4c5f11f7d.jpg" alt="Sample project image">
                    ...
                    <!--Excerpt-->
                    <div class="card-block">
                        <h4>Simple Vastu Shastra Tips for Home</h4>
                        <p>Our home is a part of our identity. It is where our heart lies. Home is not just a place to</p>
                        <a href="https://www.akashvaani.com/blog/simple-vastu-shastra-tips-for-home" type="submit" class="btn wow fadeInRight waves-effect waves-light" style="visibility: visible; animation-name: fadeInRight;border-radius: 35px;background: #ff3366;">Read<span class="mui-btn__ripple-container"><span class="mui-ripple"></span></span></a>
                    </div>
                ...
                <div class="col-lg-3 col-md-6 mb-r">
                    ...
                    <div class="view overlay hm-white-slight z-depth-2">
                        ...
                        <img src="https://www.akashvaani.com/uploads/images/full/0d88eec022b6381bdb5621a2e58956a6.jpg" alt="Sample project image">
                    ...
                    <!--Excerpt-->
                    <div class="card-block">
                        <h4>Vaastu tips for Bedroom</h4>
                        <p>Bedroom is a special room of the house. We take great efforts to make our room appealing.</p>
                        <a href="https://www.akashvaani.com/blog/vaastu-tips-for-bedroom" type="submit" class="btn wow fadeInRight waves-effect waves-light" style="visibility: visible; animation-name: fadeInRight;border-radius: 35px;background: #ff3366;">Read<span class="mui-btn__ripple-container"><span class="mui-ripple"></span></span></a>
                    </div>
...
<div class="inter_link">
  <h3><a href="https://www.akashvaani.com/vastu-consultant-in-gurgaon">Vastu Service In Gurgaon</a></h3>
</div>
 <?php /*?><div id="bottom">
