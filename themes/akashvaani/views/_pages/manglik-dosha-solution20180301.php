<link rel="stylesheet" href="<?= base_url('/api/css/style.css');?>" media="all"  type="text/css"/>
      <link href="<?php echo base_url('/assets/js/slider/css/slider.css'); ?>" rel="stylesheet">
  <link href="<?php echo base_url('/assets/js/slider/css/swiper.min.css'); ?>" rel="stylesheet">
<!--/.Navbar-->
      ...
      <section class="section extra-margins manglikform">
        ...
        <div class="row">
          ...
          <div class="col-md-5 mb-r">
            <!--Featured image-->
            <div class="view overlay hm-white-slight"> <img src="<?=resizedUrl(base_url('/assets/astrology/img/manglik.jpg'), 345, 230);?>" class="z-depth-0">
            	<a>
               	<div class="mask"></div>
              	</a> </div>
          </div>
          ...
          <div class="col-md-6 mb-r">
            <!--Excerpt-->
            <h3 style="font-weight:500">Manglik Dosh</h3>
...
<p class="myfont">The person has chances of having many enemies if there is <b>manglik dosh</b> in the twelfth house of the kundli. This can become a reason for mental illness and financial losses in the life of the person.
    ...
    <div class="row features-small">
      <!--First column-->
      <div class="col-md-1"></div>
      <div class="col-md-4 center-on-small-only"> <img src="<?=resizedUrl(base_url('/assets/astrology/img/manglikissue.png'), 400, 350);?>" alt="Manglik Dosha" class="z-depth-0"> </div>
      <!--/First column-->
      <!--Second column-->
...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-md-6 mb-r mb-h">
      <!--Excerpt-->
      <?php echo form_open('service/booking', array('class' => 'form-horizontal', 'id' => 'sendenquiry1')); ?> <?php echo form_input(array('type' => 'hidden', 'name' => 'type', 'value' => 'phone')); ?> <?php echo form_input(array('type' => 'hidden', 'name' => 'category_id', 'value' => 1)); ?> <?php echo form_input(array('type' => 'hidden', 'name' => 'reference_page', 'value' => 'Manglik Dosh form 2')); ?><?php echo form_input(array('type' => 'hidden', 'name' => 'reference_heading', 'value' => 'Astrology')); ?> 
      <h3 style="font-weight:600">Manglik Reports</h3>
          ...
          <div class="modal-content" style="padding:35px;">
            ...
            <div class="modal-body">
              ...
              <div class="md-form"> <i class="fa fa-phone prefix"></i>
                <input type="text" id="reportnumber" name="phone" class="form-control" required>
...
if($article->images){
      ...
      <div class="swiper-slide">
        <div class="slide-img">
            <a href="<?=base_url('/blog/'.$article->slug);?>">
              <img src="<?=resizedUrl(base_url(($filename) ? '/uploads/images/medium/'.$filename : '/uploads/images/default.jpg'), 380, 200)?>">
            </a>
        </div>
        <div class="slide-detail">
          <h3><?=substr(strip_tags($article->name), 0, 35);?></h3>
  ...
  <script type="text/javascript" src="<?php echo base_url('/assets/js/slider/js/swiper.min.js'); ?>"></script>
