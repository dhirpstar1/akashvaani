...
<img src="<?php echo resizedUrl(base_url('/assets/astrology/img/kundali-milan.jpg'), 347, 230); ?>" alt="Match-Make with your loved One" class="img-fluid">
          ...
          <div class="col-md-6 mb-r">
            <!--Excerpt-->
            <p style="font-size:16px;word-spacing:4px">Kundali matching also looks into factors like financial stability and other career related prospects. A guna, named Bhakoot indicates this effect.
</p>
<p style="font-size:16px;word-spacing:4px">After reaching a certain age in your life, you get to a point where you need to tie a knot of marriage with a person of your desire. Often, people have predetermined qualities of how this person should be. These qualities are often in physical terms.
</p>
<p style="font-size:16px;word-spacing:4px">But what’s important is what lies in the nature of the person rather than physical appearance. <b>Kundli</b> is, therefore, checked of both the boy and girl to see if they are compatible for each other.
</p>
          </div>
          <!--/Second column-->
        </div>
...
<section class="section feature-box" style="margin-top:3rem">
    <!--Section heading-->
    <h1 class="section-heading howorks" style="font-size:23px;margin-bottom:2rem">Kundali matching for marriage</h1>
   ...
   <div class="row features-small">
      ...
      <div class="col-md-7 center-on-small" style="margin-top:30px;">
        ...
        <div class="row">
          ...
          <div class="col-xs-10">
            <h2 class="h2-responsive" style="font-size:1.5rem;font-weight:400">Guna Milan</h2>
            <p class="myfont">
              ...
              <h2 class="h2-responsive" style="font-size:1.5rem;font-weight:400">Analysis of Kundli</h2>
              <p class="myfont">
    ...
    <h1 class="section-heading howorks" style="font-size:23px;margin-bottom:2rem">Janam Kundli Reading(Birth Chart Reading)</h1>
    <div class="col-md-12 mb-r">
      <!--Excerpt-->
...
<div class="container">
  ...
  <hr>
  <?php /* ?><section class="section" style="text-align:center">
    <!--Section heading-->
  ...
  foreach($article->images as $image){
    if(!isset($image['primary'])){
      ...
      <div class="col-lg-4 col-md-12 mb-r">
        <!--Featured image-->
        <div class="view overlay hm-white-slight z-depth-2"> <img src="<?=resizedUrl(base_url(($filename) ? '/uploads/images/medium/'.$filename : '/uploads/images/default.jpg'), 380, 200)?>" alt="<?=$article->name;?>"> <a>
          <div class="mask waves-effect waves-light"></div>
          </a> </div>
        <!--Excerpt-->
        <div class="card-block">
          <h4><?=substr(strip_tags($article->name), 0, 35);?></h4>
          <p><?=substr(strip_tags($article->description), 0, 100);?></p>
          <a href="<?=base_url('/blog/'.$article->slug);?>" type="submit" class="btn wow fadeInRight waves-effect waves-light" style="visibility: visible; animation-name: fadeInRight;border-radius: 35px;background: #ff3366;">Read<span class="mui-btn__ripple-container"><span class="mui-ripple"></span></span></a> </div>
      </div>
      <!--/First column-->
  ...
  foreach($article->images as $image){
    if(!isset($image['primary'])){
      ...
      <div class="swiper-slide">
        <div class="slide-img">
         <img src="<?=resizedUrl(base_url(($filename) ? '/uploads/images/medium/'.$filename : '/uploads/images/default.jpg'), 260, 260)?>" alt="<?=$article->name;?>">
        </div>
