      ...
      <section class="section extra-margins manglikform">
        ...
        <div class="row">
          ...
          <div class="col-md-5 mb-r">
            <!--Featured image-->
            <div class="view overlay hm-white-slight"> <img src="<?=resizedUrl(base_url('/assets/astrology/img/pregnancy.jpg'), 345, 230); ?>"> <a>
              <div class="mask"></div>
              </a> </div>
          </div>
          <!--/First column-->
          ...
          <div class="col-md-6 mb-r">
            <!--Excerpt-->
            <h3 style="font-weight:500">Child and pregnancy</h3>
