...
<!--/.Carousel Wrapper-->
  ...
  <div class="col-md-7" style="padding-top: 60px;">
                    <!--Excerpt-->
                    <h2 class="h2-responsive center-on-small-only product-name"><strong>The Story of your life.</strong></h2>
                    ...
                    <a id="button1" href="<?=base_url('/report');?>"  class="btn waves-effect waves-light type_consult">Buy Now</a>
                   <a id="button2" href="<?=base_url('/full-reports');?>" class="btn waves-effect waves-light">See details</a>
                </div>
        ...
        <div class="modal fade modal-ext" id="modal-login" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
          <div class="modal-dialog" role="document">
            ...
            <div class="modal-content" style="padding:35px;">
              <!--Body-->
              <div class="modal-body"> <?php echo form_open('services/booking', array('class' => 'form-horizontal', 'id' => 'sendenquiry1')); ?> <?php echo form_input(array('type' => 'hidden', 'name' => 'type', 'value' => 'phone')); ?> <?php echo form_input(array('type' => 'hidden', 'name' => 'category_id', 'value' => 1)); ?> <?php echo form_input(array('type' => 'hidden', 'name' => 'reference_page', 'value' => 'Marriage prediction form 2')); ?>
              <?php echo form_input(array('type' => 'hidden', 'name' => 'reference_heading', 'value' => 'Astrology')); ?> 
            ...
            <div class="row text-center">
                ...
                <div class="col-lg-3 col-md-12 mb-r">
                    ...
                    <div class="view overlay hm-white-slight z-depth-2">
                        ...
                        <img src="https://www.akashvaani.com/uploads/images/full/aaa65f8a0e3e1ac8084e2044634281a7.jpg" alt="Sample project image">
                ...
                <div class="col-lg-3 col-md-6 mb-r">
                    ...
                    <div class="view overlay hm-white-slight z-depth-2">
                        ...
                        <img src="https://www.akashvaani.com/uploads/images/full/de8c09615217d449a8f5ae436177182d.jpg" alt="Sample project image">
