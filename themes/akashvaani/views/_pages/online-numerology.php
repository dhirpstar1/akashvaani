<div class="container qa1">
    <div class="row cntn">
        <div class="col-md-9">
            ...
            <section class="section extra-margins manglikform">
                ...
                <!--Section heading-->
                <h1 class="section-heading">Online Numerology</h1>
   ...
   <div class="col-md-3 rightsidebar desktopsidebar">
    ...
    <div class="card wow fadeInUp shadowless" style="visibility: visible; animation-name: fadeInUp;">
     ...
     <?php echo form_input(array('type' => 'hidden', 'name' => 'reference_page', 'value' => 'Numerology form 1')); ?> 
...
<section class="section feature-box" style="margin-top:3rem">
  ...
  <div class="row features-small">
    ...
    <div class="col-md-4 center-on-small-only"> <img src="<?php echo base_url('/assets/astrology'); ?>/img/numerology2.jpg" alt="Online Numerology Calculator" class="z-depth-0"> </div>
    <!--/First column-->
    <!--Second column-->
  <div class="col-md-7">
  <p class="myfont">
...
<section class="section feature-box" style="margin-top:3rem">
  ...
  <div class="row features-small">
    <!--First column-->
    <div class="col-md-1"></div>
    <div class="col-md-4 center-on-small-only"> <img src="<?php echo base_url('/assets/astrology'); ?>/img/numerology3.jpg" alt="Baby Name Numerology" class="z-depth-0"> </div>
    <!--/First column-->
    <!--Second column-->
  <div class="col-md-7">
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-content" style="padding:35px;">
                ...
                <div class="modal-body">
                 ...
                 <?php echo form_input(array('type' => 'hidden', 'name' => 'type', 'value' => 'phone')); ?> 
                 <?php echo form_input(array('type' => 'hidden', 'name' => 'category_id', 'value' => 1)); ?>
                 <?php echo form_input(array('type' => 'hidden', 'name' => 'reference_page', 'value' => 'Numerology form 2')); ?> 
                 <div class="md-form">
                    <i class="fa fa-user prefix"></i>
      ...
      <div class="col-md-12">
        <div class="card">
          <blockquote class="blockquote bq-primary q1">
            <p class="bq-title">Q.1 What kind of answers can Numerology give me? </p>
            <p>Ans. Numerology examines in detail what effects numbers have on people. Know the link between your name and birthdate. <a href="#" class="read_more">...continue read</a><span class="more_text"> It answers how your name & birth date effects your life. <a href="#" class="read_less">...read less</a></span></p>
            <div class="item"> </div>
          </blockquote>
        </div>
        <div class="card">
          <blockquote class="blockquote bq-warning q2">
            <p class="bq-title">Q.2 What does my name have to do with Numerology? </p>
            <p>Ans. .  Name reflect certain aptitudes and character tendencies, as an integral part of the cosmic plan. Each letter has a numeric value that <a href="#" class="read_more1">...continue read</a><span class="more_text1"> provides a related cosmic vibration. Name is related with birthdate which depicts character, purpose in life, what motivates, and where talents may lie. Experts in numerology use the numbers to determine the best time for major moves and activities in life.<a href="#" class="read_less1">...read less</a></span></p>
          </blockquote>
        </div>
        <div class="card">
          <blockquote class="blockquote bq-success q3">
            <p class="bq-title">Q.3 my Life Path number?</p>
            <p>Ans. life path number sort of represents the journey of your life. Life path number is simple to calculate by using <a href="#" class="read_more2">...continue read</a><span class="more_text2"> your date of birth (MM/DD/YYYY) and adding all the numbers together. <a href="#" class="read_less2">...read less</a></span></p>
          </blockquote>
        </div>
        <div class="card">
          <blockquote class="blockquote bq-danger q4">
            <p class="bq-title">Q.4 Can Numerology determine romantic compatibility? </p>
            <p>Ans. Yes, Numerology depicts your characteristics, attributes of people</p>
          </blockquote>
        </div>
        <div class="card">
          <blockquote class="blockquote bq-primary q5">
            <p class="bq-title">Q.5 Benefits of Numerology? </p>
            <p>Ans. . Numerology deals with name correction. If your name is not in your favor, then corrected name brings benefits in your life. <a href="#" class="read_more4">...continue read</a><span class="more_text4">It improves fortune of a person, improves relationship, growth oriented career, and maintain stable life of yours. <a href="#" class="read_less4">...read less</a></span></p>
            <div class="item"> </div>
          </blockquote>
        </div>
        <div class="card">
          <blockquote class="blockquote bq-warning q6">
            <p class="bq-title">Q.6 Finding Your Soul Mate through Numerology? </p>
            <p>Ans. Soul number also known as heart number indicate your feelings and what you want rom your life. <a href="#" class="read_more5">...continue read</a><span class="more_text5"> The soul number helps us to explore our hidden traits and gives us opportunities to look at ourselves.<a href="#" class="read_less5">...read less</a></span></p>
          </blockquote>
        </div>
          <div class="card">
          <blockquote class="blockquote bq-success q7">
            <p class="bq-title">Q.7 How Numerology Affects Lives? </p>
            <p>Ans. Numerology affects our lives in four ways:-<br/>
             Life path number tells the journey of life, Soul number indicate your feelings, Karmik number  <a href="#" class="read_more6">...continue read</a><span class="more_text6"> tell your hope desire and fear, expression number indicate your talents and special in you. Your complete life is under the influence of numerology.<a href="#" class="read_less6">...read less</a></span></p>
          </blockquote>
        </div>
       <div class="card">
          <blockquote class="blockquote bq-danger q8">
            <p class="bq-title">Q.8 How I Became a Numerologist? </p>
            <p>Ans.We are there to teach you the concepts of your numbers. Know your name and birth date relation <a href="#" class="read_more7">...continue read</a><span class="more_text7"> We are there to teach you the concepts of your numbers. Know your name and birth date relation.<a href="#" class="read_less7">...read less</a></span></p>
          </blockquote>
        </div>
          <div class="card">
          <blockquote class="blockquote bq-warning q9">
            <p class="bq-title">Q.9 Should I change my name? </p>
            <p>Ans.If you are struggling with your life, capable of doing everything but not able to show your strength then yes you need a change name.</p>
          </blockquote>
        </div>
      </div>
    </div>
...
<div class="inter_link">
  <h3><a href="https://www.akashvaani.com/numerology-consultants-in-gurgaon">Numerology Services in Gurgaon</a></h3>
</div>
<?php /*?> <div id="bottom">
