...
<div id="carousel-example-2" class="carousel slide carousel-fade" data-ride="carousel">
    ...
    <div style="text-align: center;">
        <a id="button3" class="btn waves-effect waves-light" data-toggle="modal" data-target="#sample">View Sample Report</a>
    </div>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p><img src="<?php echo base_url('/assets/astrology/img/1. Report-Cover .png'); ?>" alt="Sample Report"></p>
      </div>
...
<!--/.Carousel Wrapper-->
  ...
  <div class="col-md-7" style="padding-top: 60px;">
                   ...
                   <?php /*?> <a id="button2" href="<?=base_url('/all-reports');?>" class="btn waves-effect waves-light">Know More</a><?php */?>
                </div>
