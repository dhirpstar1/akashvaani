  ...
  <div class="carousel-inner" role="listbox">
    ...
    <div class="carousel-item active">
      ...
      <div class="view"> <?php if($device == 'mobile'){ ?>
          <img src="<?php echo base_url('/assets/img/mobi/marriage prediction slider 1.svg'); ?>" class="img-fluid" alt="">
	  <?php }else{ ?>
        <img src="<?php echo base_url('/assets/img/marriage-prediction-slider-1.jpg'); ?>" class="img-fluid" alt="">
      <?php } ?>
...
<div class="carousel-item">
    <a href="<?=base_url('/report?lg=en&type=matchmaking_report'); ?>">
      <!--Mask color-->
      <div class="view"> <?php if($device == 'mobile'){ ?>
          <img src="<?php echo base_url('/assets/img/mobi/marriage prediction_slider_2_mobile-01.svg'); ?>" class="img-fluid" alt="">
	  <?php }else{ ?>
        <img src="<?php echo base_url('/assets/img/marriage-prediction-slider-2.jpg'); ?>" class="img-fluid" alt="">
      <?php } ?>
        <div class="full-bg-img">
        </div>
      </div>
      ...
      <div class="carousel-item">
        ...
        <!--Mask color-->
        <div class="view"> <?php if($device == 'mobile'){ ?>
          <img src="<?php echo base_url('/assets/img/mobi/marriage prediction slider 3 mobile.svg'); ?>" class="img-fluid" alt="">
	  <?php }else{ ?>
          <img src="<?php echo base_url('/assets/img/marriage-prediction-slider-3.jpg'); ?>" class="img-fluid" alt="Akashvaani Gurgaon">
      <?php } ?>
          <div class="full-bg-img">
          </div>
        </div>
  ...
  <div class="container reportcontent">
    ...
    <div class="row">
        ...
        <div id="carousel-example-5" class="carousel slide carousel-fade" data-ride="carousel" data-interval="false">
          ...
          <div class="carousel-inner kundalimatchingslider" role="listbox">
            <div class="carousel-item active">
              ...
              <div class="view hm-black-light"> <img src="<?php echo base_url('/assets/img/kundali/kundali-matching-Front Cover.png'); ?>" alt="Match-Make with your loved One" class="img-fluid"> </div>
            </div>
            <div class="carousel-item">
              <!--Mask color-->
              <p style="text-align:center;">What's Inside</p>
              <div class="view hm-black-strong"> <img src="<?php echo base_url('/assets/img/kundali/slider-2-.png'); ?>" alt="Second slide"> </div>
            </div>
            <div class="carousel-item">
              <!--Mask color-->
              <p style="text-align:center;"></p>
              <div class="view hm-black-slight"> <img src="<?php echo base_url('/assets/img/kundali/slider-3.png'); ?>" alt="Third slide"> </div>
            </div>
            <div class="carousel-item">
              <!--Mask color-->
              <p style="text-align:center;"></p>
              <div class="view hm-black-slight"> <img src="<?php echo base_url('/assets/img/kundali/slider-4.png'); ?>" alt="Third slide"> </div>
            </div>
            <div class="carousel-item">
              <!--Mask color-->
              <p style="text-align:center;"></p>
              <div class="view hm-black-slight"> <img src="<?php echo base_url('/assets/img/kundali/slider-5.png'); ?>" alt="Third slide"> </div>
            </div>
          </div>
          ...
          <!--/.Slides-->
          <!--Controls-->
          <a class="carousel-control-prev" href="#carousel-example-5" role="button" data-slide="prev"> <i class="fa fa-angle-left" aria-hidden="true"></i> <span class="sr-only">Previous</span> </a> <a class="carousel-control-next" href="#carousel-example-5" role="button" data-slide="next"> <i class="fa fa-angle-right" aria-hidden="true"></i> <span class="sr-only">Next</span> </a>
          <!--/.Controls-->
        </div>
        <!--/.Carousel Wrapper-->
      </div>
      ...
      <div class="col-md-6 col-sm-12" style="padding-top: 60px;">
        ...
        <div class="col-md-12" style="padding: 0"> <span>Introductory Price</span> <span class="cancel-price"><strike> Rs.699/-</strike></span> <span class="currnt-price" style="color:#0000FF;">Rs.399/-</span> <span class="pdf">(PDF)</span> </div>
        <div class="col-md-12" style="padding:10px 0;">
          <div class="col-md-4 col-sm-12" style="padding:0px;"><a id="button1" href="<?=base_url('/report?lg=en&type=matchmaking_report');?>" type="matchmaking"  class="btn waves-effect waves-light buy_now_matchmaking_report pull-left">Buy Now</a></div>
...
<div class="snippet-markup text-center" itemscope="" itemtype="http://schema.org/Review"> <span itemprop="author" itemscope="" itemtype="http://schema.org/Person">
  ...
  <span itemprop="itemReviewed">
    <p><i class="fa fa-quote-left"></i> I Wanted An Advice Regarding Marriage Issue. Found Out About Akashvaani.Com On Internet. I Called Them And In Less Than 5 Minutes I Was Talking To Expert Marriage Astrologer . I Got An Advice Based On My Birth Details On Call. It Was More Than Satisfying Experience. It Could Not Have Been Easier And Better Than This.</p></span>
    <!--Review-->
...
<!--/Second column-->
            ...
            <div class="col-md-4 hidden-sm-down">
              <div class="testimonial">
                ...
                <!--Content-->
                <h4>Rahul, Delhi</h4>
                <p><i class="fa fa-quote-left"></i> Thank You Akashvaani For Giving Me Instant Service When I Was In Dilemma Of Switching My Job. They Helped In Choosing The Right Decision.</p></span></div>
                <!--Review-->
			...
			<?php foreach($posts as $post): ?>
                ...
                <div class="col-lg-3 col-md-12 mb-r">
                    ...
                    <div class="view overlay hm-white-slight z-depth-2">
 						<img src="<?=base_url('/uploads/images/small/'.$post->primaryimage['filename']);?>" alt="<?=$post->name;?>">
                    ...
                    <div class="card-block">
                        ...
                        <a href="<?=base_url('/blog/'.$post->slug);?>" class="btn wow fadeInRight waves-effect waves-light" style="visibility: visible; animation-name: fadeInRight;border-radius: 35px;background: #ff3366;">Read<span class="mui-btn__ripple-container"><span class="mui-ripple"></span></span></a>
                    </div>
