...
function showDiv() {
 ...
 function showDivmrg() {
   document.getElementById('dateDivmrg').style.display = "block";
}
 $(document).click(function(e) {
  if(e.target.id!="mydivmrg"){  // if click is not in 'mydiv'
    $('#dateDivmrg').hide();
  }
});
  function showDivmglk() {
   document.getElementById('dateDivmglk').style.display = "block";
}
 $(document).click(function(e) {
  if(e.target.id!="mydivmglk"){  // if click is not in 'mydiv'
    $('#dateDivmglk').hide();
  }
});
...
function showDiv1() {
 ...
 function showDiv1mrg() {
   document.getElementById('monthDivmrg').style.display = "block";
}
 $(document).click(function(e) {
  if(e.target.id!="mydiv1mrg"){  // if click is not in 'mydiv'
    $('#monthDivmrg').hide();
  }
});
  function showDiv1mglk() {
   document.getElementById('monthDivmglk').style.display = "block";
}
 $(document).click(function(e) {
  if(e.target.id!="mydiv1mglk"){  // if click is not in 'mydiv'
    $('#monthDivmglk').hide();
  }
});
 ...
 function showDiv2mrg() {
   document.getElementById('yearDivmrg').style.display = "block";
}
 $(document).click(function(e) {
  if(e.target.id!="mydiv2mrg"){  // if click is not in 'mydiv'
    $('#yearDivmrg').hide();
  }
});
  function showDiv2mglk() {
   document.getElementById('yearDivmglk').style.display = "block";
}
 $(document).click(function(e) {
  if(e.target.id!="mydiv2mglk"){  // if click is not in 'mydiv'
    $('#yearDivmglk').hide();
  }
});
 ...
 function showDiv3mrg() {
   document.getElementById('hourDivmrg').style.display = "block";
}
 $(document).click(function(e) {
  if(e.target.id!="mydiv3mrg"){  // if click is not in 'mydiv'
    $('#hourDivmrg').hide();
  }
});
  function showDiv3mglk() {
   document.getElementById('hourDivmglk').style.display = "block";
}
 $(document).click(function(e) {
  if(e.target.id!="mydiv3mglk"){  // if click is not in 'mydiv'
    $('#hourDivmglk').hide();
  }
});
 ...
 $(document).click(function(e) {
  if(e.target.id!="mydiv4"){  // if click is not in 'mydiv'
   ...
   function showDiv4mrg() {
   document.getElementById('minuteDivmrg').style.display = "block";
}
 $(document).click(function(e) {
  if(e.target.id!="mydiv4mrg"){  // if click is not in 'mydiv'
    $('#minuteDivmrg').hide();
  }
});
    function showDiv4mglk() {
   document.getElementById('minuteDivmglk').style.display = "block";
}
 $(document).click(function(e) {
  if(e.target.id!="mydiv4mglk"){  // if click is not in 'mydiv'
    $('#minuteDivmglk').hide();
  }
});
 ...
 $(document).click(function(e) {
  ...
  function dateselect(dateid){
   ...
   function dateselectmrg(dateid){
    document.getElementById("mydivmrg").value=dateid;
     $('#datelabelmrg').addClass( 'active' );
   }
   function dateselectmglk(dateid){
    document.getElementById("mydivmglk").value=dateid;
     $('#datelabelmglk').addClass( 'active' );
   }
   ...
   function monthselect(monthid){
    ...
    function monthselectmrg(monthid){
    document.getElementById("mydiv1mrg").value=monthid;
     $('#monthlabelmrg').addClass( 'active' );
   }
    function monthselectmglk(monthid){
    document.getElementById("mydiv1mglk").value=monthid;
     $('#monthlabelmglk').addClass( 'active' );
   }
    ...
    function yearselectmrg(yearid){
    document.getElementById("mydiv2mrg").value=yearid;
     $('#yearlabelmrg').addClass( 'active' );
   }
    function yearselectmglk(yearid){
    document.getElementById("mydiv2mglk").value=yearid;
     $('#yearlabelmglk').addClass( 'active' );
   }
    ...
    function hourselectmrg(hourid){
    document.getElementById("mydiv3mrg").value=hourid;
     $('#hourlabelmrg').addClass( 'active' );
   }
     function hourselectmglk(hourid){
    document.getElementById("mydiv3mglk").value=hourid;
     $('#hourlabelmglk').addClass( 'active' );
   }
   ...
   function minuteselect(minuteid){
    ...
    function minuteselectmrg(minuteid){
    document.getElementById("mydiv4mrg").value=minuteid;
     $('#minutelabelmrg').addClass( 'active' );
   }
    function minuteselectmglk(minuteid){
    document.getElementById("mydiv4mglk").value=minuteid;
     $('#minutelabelmglk').addClass( 'active' );
   }
...
$(window).scroll(function() {    
    ...
    if(scroll >= 80) {
        ...
        $(".call-to-action").removeClass("change");
    }
});