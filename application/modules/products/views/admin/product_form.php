...
<?php echo form_open('admin/products/form/'.$id ); ?>
    <div class="row">
        <div class="col-md-9">
            <div class="tabbable">
                <ul class="nav nav-tabs">
                    ...
                    <li><a href="#product_filters" data-toggle="tab">Filters</a></li>
       ...
       <?php foreach ($filters as $filter): ?>
          <li class="list-group-item" <?php if($filter->parent_id != 0) {?> style="padding-left:50px;" <?php } ;?>><input type="checkbox" name="filters[]" value=" <?php echo $filter->id;?>"  <?php if(in_array($filter->id, $product_filters)){ echo 'checked';} ?> />&nbsp;<?php echo $filter->title;?></li>
    <?php endforeach; ?>
       </ul>
                 ...
                 <div class="tab-pane" id="product_review">
                    ...
                    <a href="<?=base_url('/admin/products/product_review/'.$id);?>" class="btn btn-info add_review pull-right addinfo" >Add</a>
                    </div>
                    <br />
                      <div class="input-group col-md-12" style="width:100%;">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title">
                    <a data-toggle="collapse" data-parent="#accordion" href="#collapse<?=$item->id;?>"><?=$item->customer_name;?></a>
            ...
            <div id="collapse<?=$item->id;?>" class="panel-collapse collapse ">
                ...
                <div class="col-md-4">
                <img src="<?php echo base_url('uploads/images/full/'.$item->customer_image); ?>" class="img-circle col-md-6" alt="">
                </div>
                <p><?=$item->review;?></p>
                
                
                
      <a href="<?=base_url('/admin/products/product_review/'.$id.'/'.$item->id);?>" class="btn btn-info pull-left addinfo">Edit</a>
      <a href="<?=base_url('/admin/products/product_review_delete/'.$id.'/'.$item->id);?>" class="btn btn-info pull-right" onclick="return confirm('Are you sure?');">Delete</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            ...
            <?php endforeach; if($id):?>
        <div class="well">
        <a href="<?=base_url('/admin/products/product_addinfo/'.$id);?>" class="btn btn-info addinfo">Additional informations</a>
        <hr />
        <div class="bs-example">
    ...
    <?php foreach($add_info as $item): ?>
      ...
      <a href="<?=base_url('/admin/products/product_addinfo/'.$id.'/'.$item->id);?>" class="btn btn-info pull-left addinfo">Edit</a>
