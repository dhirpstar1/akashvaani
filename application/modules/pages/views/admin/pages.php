...
<div class="text-right">
    ...
    <a class="btn btn-primary" href="<?php echo site_url('admin/pages/link_form'); ?>"><i class="icon-plus"></i>Add Marketing Page</a>
</div>
    ...
    <tbody>
        ...
        function list_pages($parent_id, $pages, $sub='') {
            ...
            <tr>
                ...
                <td><?php echo  ($sub.$page->type == 0)? 'Website':'Marketing'; ?></td>
                <td class="text-right">
                    <div class="btn-group">
