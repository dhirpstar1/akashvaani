...
<div class="text-left"> 
     <a href="<?=base_url('/admin/settings/send_messages/register');?>" class="btn btn-primary">Registered</a>
        ...
        <a href="<?=base_url('/admin/settings/send_messages/getreport');?>" class="btn btn-primary">Get Report Data</a>
</div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
         <div class="col-md-12"> Subject:- 
            <input type="text" placeholder="Subject" value=" Astrology Guidance for Marriage, Career Issues. Easy, Accurate, Fast. Start now." id="subject" name="subject" class="form-control"> 
        </div><br><br>
        <div class="col-md-12"> Template ID:
            <input type="text" placeholder="Template Id" value="c8c82694-6647-4494-b3a5-7e48484e7484" id="template_id" name="template_id" class="form-control"> 
        </div>
