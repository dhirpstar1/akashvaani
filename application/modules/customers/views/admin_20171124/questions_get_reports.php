...
<?php foreach ($questions as $key => $question):?>
  ...
  <?php } ?>  
  <?php if($type == 'basic_horoscope_pdf'){ ?>
       <a class="btn btn-default send_button" href="<?php echo site_url('admin/customers/send_report/'.$question->id); ?>" id="<?=$question->id;?>"
        title="Send Report"><i class="glyphicon glyphicon-share-alt"></i></a>
  <?php }elseif($type == 'pro_horoscope_pdf'){ ?>      
       <a class="btn btn-default send_button" href="<?php echo site_url('admin/customers/send_report/'.$question->id.'/pro_horoscope'); ?>" 
        id="<?=$question->id;?>" title="Send Report"><i class="glyphicon glyphicon-share-alt"></i></a>
  <?php } elseif($type == 'match_making_pdf'){ ?>      
       <a class="btn btn-default send_button" href="<?php echo site_url('admin/customers/send_report/'.$question->id.'/match_making'); ?>" 
        id="<?=$question->id;?>" title="Send Report"><i class="glyphicon glyphicon-share-alt"></i></a>
  <?php } ?>      
