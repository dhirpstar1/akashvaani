...
<?php echo form_open('admin/customers/report_form/'.$question->id); ?>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                ...
                <ul> 
                <?php foreach($questions as $item): if($question->question):
                        echo '<li>'.$item->question.'</li>'; 
                  endif;  endforeach; ?>
    ...
    <?php endif; ?>
     ...
     <div class="row">
           <div class="col-md-12"> <label>Date Of Birth </label><?php if($question->question == GET_KUNDALI_REPORT): echo $question->mname; endif; ?> 
            <div class="form-group">
     ...
     <div class="row"><br />
           <div class="col-md-12"> <label>Time of Birth </label><?php if($question->question == GET_KUNDALI_REPORT): echo $question->mname; endif; ?> 
            <div class="form-group">
    ...
    <?php if($question->question == GET_KUNDALI_REPORT || $question->question == 'Special Commentary - Kundali Matching Report'):?>   
	...
	<br /><br />
	 ...
	 <div class="row">
           <div class="col-md-12">
            <div class="form-group">
                <label>  Birth Place :-  <?php if($question->question == GET_KUNDALI_REPORT || $question->question == 'Special Commentary - Kundali Matching Report'): echo $question->fname; endif; ?></label>
     ...
     <div class="row">
           <div class="col-md-12">  <label>Time Of Birth:- <?php if($question->question == GET_KUNDALI_REPORT || $question->question == 'Special Commentary - Kundali Matching Report'): echo $question->fname; endif; ?> </label>
            <div class="form-group">
     ...
     <div class="row"><br />
           <div class="col-md-12"> <label> <?php if($question->question == GET_KUNDALI_REPORT || $question->question == 'Special Commentary - Kundali Matching Report'): echo $question->fname; endif; ?> Time of Birth</label>
            <div class="form-group">
                <div class="col-md-4">Hours:
...
<div class="col-md-12">
    ...
    <?php if($question->question == 'Get Story of My Life extended report (70 pages).' || $question->question == 'Special Commentary - The story of my Life report (70 Pages)'){ ?>
        ...
        Download Report</a>
  <?php }else if($question->question == 'Get Kundali Matching Report.' || $question->question == 'Special Commentary - Kundali Matching Report'){ ?>
