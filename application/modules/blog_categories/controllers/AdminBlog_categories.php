...
/**
 * AdminBlog_categories Class
 *
 * @package GoCart
 * @subpackage Controllers
 * @category AdminBlog_categories
 * @author Clear Sky Designs
 * @link http://gocartdv.com
 */

class AdminBlog_categories extends Admin { 
    ...
    { 
        ...
        \CI::load()->model('Blog_categories');
    }
    
    function index()
    { 
        $data['groups'] = \CI::Customers()->get_groups();
        $data['page_title'] = lang('blog_categories');
        $data['blog_categories'] = \CI::Blog_categories()->get_categories_tiered(true);
        
        $this->view('blog_categories', $data);
    }
    ...
    function form($id = false)
    {
        ...
        $data['blog_categories'] = \CI::Blog_categories()->getBlog_categoryOptionsMenu($id);
        ...
        if ($id)
        { 
            $category = \CI::Blog_categories()->find($id);
        ...
        {
            $this->view('blog_category_form', $data);
        }
        else
        {
            ...
            if($id)
            {
                $slug = \CI::Blog_categories()->validate_slug($slug, $category->id);
            }
            else
            {
                $slug = \CI::Blog_categories()->validate_slug($slug);
            }
            ...
            $category_id = \CI::Blog_categories()->save($save);
