                    ...
                    <div id="carousel-example-1" class="carousel slide carousel-fade z-depth-1-half" data-ride="carousel">
                        ...
                        <div class="carousel-inner" role="listbox">
                            ...
                            <div class="carousel-item active">
                                <a href="#!"><img src="<?=base_url(($category->image) ? '/uploads/images/full/'.$category->image : '/uploads/images/default_blog_view.jpg');?>" alt="First slide"></a>
                            </div>
                            <!--/First slide-->
                        </div>
                        <!--/Slides-->
...
<div class="col-xl-8 col-md-12">
                    ...
                    <h2 class="main-heading">Browsing: <strong><?=$category->name;?></strong></h2>
                    
                    <!--Section: Blog v.3-->
                    <section class="section extra-margins">
					<?php foreach($categoryarticles as $article): $filename = $article->primaryimage['filename'];
if($article->images){
