            ...
            <div class="tab-content">
                <div class="tab-pane active" id="blog_info">
                    ...
                    <div class="form-group">
                        ...
                        <?php echo form_textarea(['name'=>'description', 'class'=>'ckeditor', 'value'=>assign_value('description', $description)]); ?>
                    </div>

                    <div class="form-group">
                        <label><?php echo lang('excerpt');?></label>
                        <?php echo form_textarea(['name'=>'excerpt', 'value'=>assign_value('excerpt', $excerpt), 'class'=>'ckeditor']); ?>
                    </div>
