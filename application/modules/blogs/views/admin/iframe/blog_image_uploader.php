...
<?php if($file_name):?>
    ...
    parent.addBlogImage(uploaded[0], filename, '', '', '');
<?php endif;?>
...
<?php echo form_open_multipart('admin/blogs/blog_image_upload');?>
    <div class="input-group">
        <?php echo form_upload(array('name'=>'userfile', 'class'=>'form-control file'));?>
