        ...
        <div class="row">
          <div class="col-md-4 col-sm-4 col-xs-4">
            ...
            <div class="view overlay hm-white-slight">
              <img src="<?=base_url(($article->primaryimage['filename'])? '/uploads/images/thumbnails/'.$article->primaryimage['filename'] : '/uploads/images/default.jpg');?>" class="img-fluid" alt="<?=$article->primaryimage['alt']?>">
              <a>
          ...
          <div class="col-md-8 col-sm-8 col-xs-8">
            ...
            <div class="post-data">
              ...
              <a class="hide"><i class="fa fa-comments-o"></i> 114</a>
            </div>
          </div>
          <!--/ Excerpt -->
        </div>
...
<?php foreach($recommended as $article): ?>
          <div class="single-post">
            ...
            <div class="row">
              ...
              <div class="col-md-4 col-sm-4 col-xs-4">
                <div class="view overlay hm-white-slight">
                  <img src="<?=base_url(($article->primaryimage['filename'])? '/uploads/images/thumbnails/'.$article->primaryimage['filename'] : '/uploads/images/default.jpg');?>" class="img-fluid" alt="">
                  <a>
                    <div class="mask waves-light waves-effect waves-light"></div>
                  </a>
                </div>
...
<div class="row">
        ...
        <?php foreach($taglist as $tag){ ?>
        		<div class="chip">
     		<a href="<?=base_url('tagsearch/'.$tag->name);?>"><?=$tag->name;?></a> 
				</div>
        <?php } ?>
</div>
</div>
			...
			<form method="post" action="#" id="subscribe">
              ...
              <div class="md-form">
                <i class="fa fa-envelope prefix"></i>
                 <?php echo form_input(array('type' => 'email', 'name' => 'email', 'class' => 'form-control', 'required' => 'required')); ?>
                <label for="form2">Your email</label>
              </div>
<div class="col=md-12" align="center" id="subscribereturn"></div>
              <div class="text-center">
                <button class="btn btn-rounded btn-default waves-effect waves-light">Send</button>
              </div>
...
<script>
  ...
  <!--    <section class="wow fadeIn" data-wow-delay="0.3s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeIn;margin-top:3rem">
    <div class="offer-Btn"><a class="button button-offer" href="javascript: void(0)">Quick Connect To  Our Expert</a></div>
    </section> -->