...
<div style="margin:10px 0px;">
    <div class="row">
        ...
        <div class="col-md-3">
            ...
            <?php endforeach;?>
             <h3>Payment Ststus</h3>
            <div><?php if($order->transaction->transaction_id): ?> <span class="btn btn-success">Transaction ID :- #<?php echo $order->transaction->transaction_id;?></span> <?php else: ?> <span class="btn btn-danger">Pending</span> <?php endif; ?></div>
        </div>
        <div class="col-md-3">
