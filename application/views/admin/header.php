    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo site_url('admin');?>">Akashvaani</a>
            </div>
                ...
                <ul class="nav navbar-nav">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <?php if(CI::auth()->check_access('Admin')) : ?>
                                <li><a href="<?php echo site_url('admin/customers');?>"><?php echo lang('common_customers'); ?></a></li>
                                 <li><a href="<?php echo site_url('admin/customers/questions');?>">Customer Questions</a></li>
                                  <li><a href="<?php echo site_url('admin/customers/questionsgetreports');?>">Customer Basic Reports (25 Pages)</a></li>
                                  <?php if(CI::session()->userdata('admin')['id'] == 2): ?>
                                     <li><a href="<?php echo site_url('admin/customers/questionsgetreports/pro_horoscope_pdf');?>">Customer Extended Reports (70 Pages)</a></li>
                                     <li><a href="<?php echo site_url('admin/customers/questionsgetreports/match_making_pdf');?>">Kundali Matching Reports</a></li>
                                  <?php endif; ?>   
                                     
                                 <li><a href="<?php echo site_url('admin/customers/enquiries');?>">All Inquiries</a></li>
                                   <li><a href="<?php echo site_url('admin/customers/report_enquiries/all');?>">Report Inquiries</a></li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li><a href="<?php echo site_url('admin/blogs');?>">Posts</a></li>
                            <li><a href="<?php echo site_url('admin/blog_categories');?>">Post Category</a></li>
                            <li><a href="<?php echo site_url('admin/services');?>">Custom Services</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li><a href="<?php echo site_url('admin/settings/canned_messages');?>"><?php echo lang('common_canned_messages'); ?></a></li>
                             <li><a href="<?php echo site_url('admin/settings/send_messages');?>">Send Messages</a></li>
                            ...
                            <li><a href="<?php echo site_url('admin/locations/constants');?>">Constants</a></li>
